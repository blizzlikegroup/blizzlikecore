...
struct BLIZZLIKE_DLL_DECL guardAI : public ScriptedAI
{
    public:
...
struct BLIZZLIKE_DLL_DECL guardAI_orgrimmar : public guardAI
{
...
struct BLIZZLIKE_DLL_DECL guardAI_stormwind : public guardAI
{

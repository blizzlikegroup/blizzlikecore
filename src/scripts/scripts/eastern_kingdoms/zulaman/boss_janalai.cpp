...
struct BLIZZLIKE_DLL_DECL boss_janalaiAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_amanishi_hatcherAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_dragonhawk_eggAI : public Scripted_NoMovementAI
{
...
// TODO Remove this 'script' when combat can be proper prevented from core-side
struct BLIZZLIKE_DLL_DECL npc_janalai_firebombAI : public Scripted_NoMovementAI
{

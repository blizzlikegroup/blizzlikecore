...
struct BLIZZLIKE_DLL_DECL npc_kelerun_bloodmournAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_prospector_anvilwardAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_apprentice_mirvedaAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_infused_crystalAI : public Scripted_NoMovementAI
{

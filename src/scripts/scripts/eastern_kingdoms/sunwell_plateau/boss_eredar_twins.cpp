...
struct BLIZZLIKE_DLL_DECL boss_alythessAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_sacrolashAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_shadow_imageAI : public ScriptedAI
{

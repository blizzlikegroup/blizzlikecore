...
struct BLIZZLIKE_DLL_DECL boss_kalecgosAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_sathrovarrAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_kalecgos_humanoidAI : public ScriptedAI
{

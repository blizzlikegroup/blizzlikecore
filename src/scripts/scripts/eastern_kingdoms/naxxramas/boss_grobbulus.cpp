...
SD%Complete: 80
SDComment: Timer need more care; Spells of Adds (Posion Cloud) need BlizzLike Fixes, and further handling
...
struct BLIZZLIKE_DLL_DECL boss_grobbulusAI : public ScriptedAI
{

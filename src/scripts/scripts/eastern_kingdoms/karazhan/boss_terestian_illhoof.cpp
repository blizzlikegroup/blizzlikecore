...
struct BLIZZLIKE_DLL_DECL boss_terestianAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_fiendish_portalAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mob_demon_chainAI : public Scripted_NoMovementAI
{

...
struct BLIZZLIKE_DLL_DECL boss_dorotheeAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_strawmanAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_tinheadAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_roarAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_croneAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_bigbadwolfAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_julianneAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_romuloAI : public ScriptedAI
{

...
struct BLIZZLIKE_DLL_DECL npc_grimstoneAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_rocknotAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_marshal_windsorAI : public npc_escortAI
{

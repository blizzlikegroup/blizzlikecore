...
struct BLIZZLIKE_DLL_DECL mob_lumpAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_maghar_captiveAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_creditmarker_visit_with_ancestorsAI : public ScriptedAI
{

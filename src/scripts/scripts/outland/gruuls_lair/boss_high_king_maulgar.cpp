...
struct BLIZZLIKE_DLL_DECL boss_high_king_maulgarAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL Council_Base_AI : public ScriptedAI
{
...
// Olm The Summoner AI
struct BLIZZLIKE_DLL_DECL boss_olm_the_summonerAI : public Council_Base_AI
{
...
struct BLIZZLIKE_DLL_DECL boss_kiggler_the_crazedAI : public Council_Base_AI
{
...
struct BLIZZLIKE_DLL_DECL boss_blindeye_the_seerAI : public Council_Base_AI
{
...
// Krosh Firehand AI
struct BLIZZLIKE_DLL_DECL boss_krosh_firehandAI : public Council_Base_AI
{

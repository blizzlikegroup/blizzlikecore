...
struct BLIZZLIKE_DLL_DECL boss_ahuneAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL npc_frozen_coreAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL npc_ice_spear_bunnyAI : public Scripted_NoMovementAI
{

...
struct BLIZZLIKE_DLL_DECL npc_dirty_larryAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_khadgars_servantAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_salsalabimAI : public ScriptedAI
{

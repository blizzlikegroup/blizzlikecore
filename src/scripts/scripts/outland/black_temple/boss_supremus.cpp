...
struct BLIZZLIKE_DLL_DECL molten_flameAI : public Scripted_NoMovementAI
{
...
// TODO Remove this 'script' when combat movement can be proper prevented from core-side
struct BLIZZLIKE_DLL_DECL npc_volcanoAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL boss_supremusAI : public ScriptedAI
{

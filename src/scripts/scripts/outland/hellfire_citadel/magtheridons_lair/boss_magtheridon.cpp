...
struct BLIZZLIKE_DLL_DECL boss_magtheridonAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mob_hellfire_channelerAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_target_triggerAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL mob_abyssalAI : public ScriptedAI
{

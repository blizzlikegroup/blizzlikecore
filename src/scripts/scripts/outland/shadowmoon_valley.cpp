...
struct BLIZZLIKE_DLL_DECL mob_mature_netherwing_drakeAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mob_enslaved_netherwing_drakeAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_dragonmaw_peonAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_wildaAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL mob_torlothAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_lord_illidan_stormrageAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL npc_totem_of_spiritsAI : public ScriptedPetAI
{
...
struct BLIZZLIKE_DLL_DECL npc_spawned_oronok_tornheartAI : public ScriptedAI, private DialogueHelper
{
...
struct BLIZZLIKE_DLL_DECL npc_domesticated_felboarAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_veneratus_spawn_nodeAI : public Scripted_NoMovementAI
{

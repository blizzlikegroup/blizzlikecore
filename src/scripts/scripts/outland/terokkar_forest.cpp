...
struct BLIZZLIKE_DLL_DECL mob_unkor_the_ruthlessAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mob_netherweb_victimAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_akunoAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_hungry_nether_rayAI : public ScriptedPetAI
{
...
struct BLIZZLIKE_DLL_DECL npc_letollAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_mana_bomb_exp_triggerAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_captive_child : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_isla_starmaneAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_skywingAI : public npc_escortAI
{

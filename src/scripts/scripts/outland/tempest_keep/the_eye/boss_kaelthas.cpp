...
struct BLIZZLIKE_DLL_DECL boss_kaelthasAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL advisor_base_ai : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_thaladred_the_darkenerAI : public advisor_base_ai
{
...
struct BLIZZLIKE_DLL_DECL boss_lord_sanguinarAI : public advisor_base_ai
{
...
struct BLIZZLIKE_DLL_DECL boss_grand_astromancer_capernianAI : public advisor_base_ai
{
...
struct BLIZZLIKE_DLL_DECL boss_master_engineer_telonicusAI : public advisor_base_ai
{
...
struct BLIZZLIKE_DLL_DECL mob_phoenix_tkAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mob_phoenix_egg_tkAI : public Scripted_NoMovementAI
{

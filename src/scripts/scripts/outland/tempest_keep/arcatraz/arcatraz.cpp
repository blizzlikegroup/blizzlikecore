...
struct BLIZZLIKE_DLL_DECL npc_millhouse_manastormAI : public ScriptedAI, private DialogueHelper
{
...
struct BLIZZLIKE_DLL_DECL npc_warden_mellicharAI : public ScriptedAI
{

...
struct BLIZZLIKE_DLL_DECL npc_aged_dying_ancient_kodoAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_dalinda_malemAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_melizza_brimbuzzleAI : public npc_escortAI, private DialogueHelper
{

...
struct BLIZZLIKE_DLL_DECL npc_rizzle_sprysprocketAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_depth_chargeAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL mobs_spitelashesAI : public ScriptedAI
{

...
struct BLIZZLIKE_DLL_DECL npc_clintar_dw_spiritAI : public npc_escortAI
{
...
struct BLIZZLIKE_DLL_DECL npc_keeper_remulosAI : public npc_escortAI, private DialogueHelper
{
...
struct BLIZZLIKE_DLL_DECL boss_eranikusAI : public ScriptedAI
{

...
struct BLIZZLIKE_DLL_DECL npc_thrall_old_hillsbradAI : public npc_escortAI, private DialogueHelper
{
...
struct BLIZZLIKE_DLL_DECL npc_tarethaAI : public npc_escortAI, private DialogueHelper
{

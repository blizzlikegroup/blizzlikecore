...
struct BLIZZLIKE_DLL_DECL npc_general_andorovAI : public ScriptedAI, private DialogueHelper
{
...
struct BLIZZLIKE_DLL_DECL npc_kaldorei_eliteAI : public ScriptedAI
{

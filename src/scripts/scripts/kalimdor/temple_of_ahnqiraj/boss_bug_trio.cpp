...
struct BLIZZLIKE_DLL_DECL boss_kriAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_vemAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_yaujAI : public ScriptedAI
{

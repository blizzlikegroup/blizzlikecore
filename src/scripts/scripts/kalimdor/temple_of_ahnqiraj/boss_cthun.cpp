...
struct BLIZZLIKE_DLL_DECL boss_eye_of_cthunAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL boss_cthunAI : public Scripted_NoMovementAI
{
...
struct BLIZZLIKE_DLL_DECL npc_giant_claw_tentacleAI : public Scripted_NoMovementAI
{

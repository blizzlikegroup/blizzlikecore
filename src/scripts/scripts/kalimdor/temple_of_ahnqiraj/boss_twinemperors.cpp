...
struct BLIZZLIKE_DLL_DECL boss_twin_emperorsAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL boss_veknilashAI : public boss_twin_emperorsAI
{
...
struct BLIZZLIKE_DLL_DECL boss_veklorAI : public boss_twin_emperorsAI
{

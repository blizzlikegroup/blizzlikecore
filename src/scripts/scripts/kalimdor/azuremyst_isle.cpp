...
struct BLIZZLIKE_DLL_DECL npc_draenei_survivorAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_engineer_spark_overgrindAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_injured_draeneiAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_magwinAI : public npc_escortAI
{

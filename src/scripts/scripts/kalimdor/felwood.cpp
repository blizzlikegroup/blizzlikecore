...
struct BLIZZLIKE_DLL_DECL npc_kittenAI : public FollowerAI
{
...
struct BLIZZLIKE_DLL_DECL npc_niby_the_almightyAI : public ScriptedAI
{
...
struct BLIZZLIKE_DLL_DECL npc_kroshiusAI : public ScriptedAI
{

 ...
 *                  EASTERN KINGDOMS
 */
struct BLIZZLIKE_DLL_DECL world_map_eastern_kingdoms : public ScriptedMap
{
 ...
 *                     KALIMDOR
 */
struct BLIZZLIKE_DLL_DECL world_map_kalimdor : public ScriptedMap
{
 ...
 *                     OUTLAND
 */
struct BLIZZLIKE_DLL_DECL world_map_outland : public ScriptedMap
{

...
/// Documentation of CreatureAI functions can be found in BlizzLike source
// Only list them here again to ensure that the interface between SD2 and the core is not changed unnoticed
struct BLIZZLIKE_DLL_DECL ScriptedAI : public CreatureAI
{
    public:
...
struct BLIZZLIKE_DLL_DECL Scripted_NoMovementAI : public ScriptedAI
{

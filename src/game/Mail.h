 ...
 *
 * @file Mail.h
 * This file contains the the headers needed for BlizzLike to handle mails.
 *
 */
...
class MailDraft
{
    ...
    public:                                                 // modifiers
        ...
        MailDraft& SetSubjectAndBodyId(std::string subject, uint32 itemTextId) { m_subject = subject; BLIZZLIKE_ASSERT(!m_bodyId); m_bodyId = itemTextId; return *this; }

...
class BLIZZLIKE_DLL_SPEC Object
{
    public:
        virtual ~Object();
        ...
        {
            BLIZZLIKE_ASSERT(index < m_valuesCount || PrintIndexError(index , false));
        ...
        {
            BLIZZLIKE_ASSERT(index + 1 < m_valuesCount || PrintIndexError(index , false));
...
class BLIZZLIKE_DLL_SPEC WorldObject : public Object
{
    ...
    public:
        ...
        class BLIZZLIKE_DLL_SPEC UpdateHelper
        {
            public:
        ...
        void SetMap(Map* map);
        Map* GetMap() const { BLIZZLIKE_ASSERT(m_currMap); return m_currMap; }

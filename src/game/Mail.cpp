 ...
 *
 * @file Mail.cpp
 * This file contains the code needed for BlizzLike to handle mails.
 *
 */
...
{
    BLIZZLIKE_ASSERT(!receiver || receiver->GetObjectGuid() == receiver_guid);
}

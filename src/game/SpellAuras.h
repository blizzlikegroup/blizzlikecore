...
class BLIZZLIKE_DLL_SPEC SpellAuraHolder
{
    public:
...
class BLIZZLIKE_DLL_SPEC AreaAura : public Aura
{
    public:
...
class BLIZZLIKE_DLL_SPEC PersistentAreaAura : public Aura
{
    public:
...
class BLIZZLIKE_DLL_SPEC SingleEnemyTargetAura : public Aura
{
        friend Aura* CreateAura(SpellEntry const* spellproto, SpellEffectIndex eff, int32* currentBasePoints, SpellAuraHolder* holder, Unit* target, Unit* caster, Item* castItem);

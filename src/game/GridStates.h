...
class BLIZZLIKE_DLL_DECL GridState
{
    public:
...
class BLIZZLIKE_DLL_DECL InvalidState : public GridState
{
    public:
...
class BLIZZLIKE_DLL_DECL ActiveState : public GridState
{
    public:
...
class BLIZZLIKE_DLL_DECL IdleState : public GridState
{
    public:
...
class BLIZZLIKE_DLL_DECL RemovalState : public GridState
{
    public:

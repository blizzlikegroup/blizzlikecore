    ...
    switch (type)
    {
        ...
        case CHAT_MSG_AFK:
        {
            ...
            if (!_player->isInCombat())
            {
                ...
                {
                    _player->autoReplyMsg = msg.empty() ? GetBlizzLikeString(LANG_PLAYER_AFK_DEFAULT) : msg;
        ...
        case CHAT_MSG_DND:
        {
            ...
            {
                _player->autoReplyMsg = msg.empty() ? GetBlizzLikeString(LANG_PLAYER_DND_DEFAULT) : msg;
...
void WorldSession::HandleTextEmoteOpcode(WorldPacket& recv_data)
{
    ...
    BlizzLike::EmoteChatBuilder emote_builder(*GetPlayer(), text_emote, emoteNum, unit);
    BlizzLike::LocalizedPacketDo<BlizzLike::EmoteChatBuilder > emote_do(emote_builder);
    BlizzLike::CameraDistWorker<BlizzLike::LocalizedPacketDo<BlizzLike::EmoteChatBuilder > > emote_worker(GetPlayer(), sWorld.getConfig(CONFIG_FLOAT_LISTEN_RANGE_TEXTEMOTE), emote_do);

...
#ifndef BLIZZLIKE_GRIDMAP_H
#define BLIZZLIKE_GRIDMAP_H
...
class BLIZZLIKE_DLL_SPEC Referencable
{
    public:
...
class BLIZZLIKE_DLL_SPEC TerrainInfo : public Referencable<AtomicLong>
{
    public:
...
class BLIZZLIKE_DLL_DECL TerrainManager : public BlizzLike::Singleton<TerrainManager, BlizzLike::ClassLevelLockable<TerrainManager, ACE_Thread_Mutex> >
{
        typedef UNORDERED_MAP<uint32,  TerrainInfo*> TerrainDataMap;
        friend class BlizzLike::OperatorNew<TerrainManager>;
    ...
    private:
        ...
        typedef BlizzLike::ClassLevelLockable<TerrainManager, ACE_Thread_Mutex>::Lock Guard;

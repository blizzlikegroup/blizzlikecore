...
#ifndef BLIZZLIKESERVER_MOVESPLINEINIT_H
#define BLIZZLIKESERVER_MOVESPLINEINIT_H
...
namespace Movement
{
     ...
     */
    class BLIZZLIKE_DLL_SPEC MoveSplineInit
    {
        public:
...
#endif // BLIZZLIKESERVER_MOVESPLINEINIT_H

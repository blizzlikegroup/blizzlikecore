...
#ifndef BLIZZLIKESERVER_SPLINE_H
#define BLIZZLIKESERVER_SPLINE_H
...
namespace Movement
{
    class SplineBase
    {
        ...
        protected:
            ...
            void UninitializedSpline() const { BLIZZLIKE_ASSERT(false);}
        ...
        public:
            ...
            template<class T> inline void initLengths(T& cacher)
            {
                ...
                while (i < index_hi)
                {
                    ...
                    BLIZZLIKE_ASSERT(prev_length <= new_length);
...
#endif // BLIZZLIKESERVER_SPLINE_H

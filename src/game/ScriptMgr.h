...
class ScriptMgr
{
    ...
    private:
        ...
        {
            ptr = (T)BLIZZLIKE_GET_PROC_ADDR(m_hScriptLib, name);
        }
        ...
        BLIZZLIKE_LIBRARY_HANDLE   m_hScriptLib;

        // atomic op counter for active scripts amount
        ACE_Atomic_Op<ACE_Thread_Mutex, long> m_scheduledScripts;

        void (BLIZZLIKE_IMPORT* m_pOnInitScriptLibrary)();
        void (BLIZZLIKE_IMPORT* m_pOnFreeScriptLibrary)();
        const char*(BLIZZLIKE_IMPORT* m_pGetScriptLibraryVersion)();

        CreatureAI*(BLIZZLIKE_IMPORT* m_pGetCreatureAI)(Creature*);
        InstanceData*(BLIZZLIKE_IMPORT* m_pCreateInstanceData)(Map*);

        bool (BLIZZLIKE_IMPORT* m_pOnGossipHello)(Player*, Creature*);
        bool (BLIZZLIKE_IMPORT* m_pOnGOGossipHello)(Player*, GameObject*);
        bool (BLIZZLIKE_IMPORT* m_pOnGossipSelect)(Player*, Creature*, uint32, uint32);
        bool (BLIZZLIKE_IMPORT* m_pOnGOGossipSelect)(Player*, GameObject*, uint32, uint32);
        bool (BLIZZLIKE_IMPORT* m_pOnGossipSelectWithCode)(Player*, Creature*, uint32, uint32, const char*);
        bool (BLIZZLIKE_IMPORT* m_pOnGOGossipSelectWithCode)(Player*, GameObject*, uint32, uint32, const char*);
        bool (BLIZZLIKE_IMPORT* m_pOnQuestAccept)(Player*, Creature*, Quest const*);
        bool (BLIZZLIKE_IMPORT* m_pOnGOQuestAccept)(Player*, GameObject*, Quest const*);
        bool (BLIZZLIKE_IMPORT* m_pOnItemQuestAccept)(Player*, Item*, Quest const*);
        bool (BLIZZLIKE_IMPORT* m_pOnQuestRewarded)(Player*, Creature*, Quest const*);
        bool (BLIZZLIKE_IMPORT* m_pOnGOQuestRewarded)(Player*, GameObject*, Quest const*);
        uint32(BLIZZLIKE_IMPORT* m_pGetNPCDialogStatus)(Player*, Creature*);
        uint32(BLIZZLIKE_IMPORT* m_pGetGODialogStatus)(Player*, GameObject*);
        bool (BLIZZLIKE_IMPORT* m_pOnGOUse)(Player*, GameObject*);
        bool (BLIZZLIKE_IMPORT* m_pOnItemUse)(Player*, Item*, SpellCastTargets const&);
        bool (BLIZZLIKE_IMPORT* m_pOnAreaTrigger)(Player*, AreaTriggerEntry const*);
        bool (BLIZZLIKE_IMPORT* m_pOnProcessEvent)(uint32, Object*, Object*, bool);
        bool (BLIZZLIKE_IMPORT* m_pOnEffectDummyCreature)(Unit*, uint32, SpellEffectIndex, Creature*, ObjectGuid);
        bool (BLIZZLIKE_IMPORT* m_pOnEffectDummyGO)(Unit*, uint32, SpellEffectIndex, GameObject*, ObjectGuid);
        bool (BLIZZLIKE_IMPORT* m_pOnEffectDummyItem)(Unit*, uint32, SpellEffectIndex, Item*, ObjectGuid);
        bool (BLIZZLIKE_IMPORT* m_pOnEffectScriptEffectCreature)(Unit*, uint32, SpellEffectIndex, Creature*, ObjectGuid);
        bool (BLIZZLIKE_IMPORT* m_pOnAuraDummy)(Aura const*, bool);
};
...
BLIZZLIKE_DLL_SPEC uint32 GetAreaTriggerScriptId(uint32 triggerId);
BLIZZLIKE_DLL_SPEC uint32 GetEventIdScriptId(uint32 eventId);
BLIZZLIKE_DLL_SPEC uint32 GetScriptId(const char* name);
BLIZZLIKE_DLL_SPEC char const* GetScriptName(uint32 id);
BLIZZLIKE_DLL_SPEC uint32 GetScriptIdsCount();

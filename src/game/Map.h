...
class BLIZZLIKE_DLL_SPEC Map : public GridRefManager<NGridType>
{
...
class BLIZZLIKE_DLL_SPEC WorldMap : public Map
{
    private:
...
class BLIZZLIKE_DLL_SPEC DungeonMap : public Map
{
    private:
        using Map::GetPersistentState;                      // hide in subclass for overwrite
    public:
...
class BLIZZLIKE_DLL_SPEC BattleGroundMap : public Map
{
    private:
        using Map::GetPersistentState;                      // hide in subclass for overwrite
    public:

...
void WorldSession::HandlePetitionShowSignOpcode(WorldPacket& recv_data)
{
    ...
    data << uint32(petitionguid_low);                       // guild guid (in BlizzLike always same as GUID_LOPART(petitionguid)
...
void WorldSession::SendPetitionQueryOpcode(ObjectGuid petitionguid)
{
    ...
    data << uint32(petitionLowGuid);                        // guild/team guid (in BlizzLike always same as GUID_LOPART(petition guid)
...
void WorldSession::HandleOfferPetitionOpcode(WorldPacket& recv_data)
{
    ...
    data << uint32(petitionGuid.GetCounter());              // guild guid (in BlizzLike always same as low part of petition guid)
    data << uint8(signs);                                   // sign's count

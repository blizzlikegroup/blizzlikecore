...
class BLIZZLIKE_DLL_DECL MapPersistentStateManager : public BlizzLike::Singleton<MapPersistentStateManager, BlizzLike::ClassLevelLockable<MapPersistentStateManager, ACE_Thread_Mutex> >
{
...
#define sMapPersistentStateMgr BlizzLike::Singleton<MapPersistentStateManager>::Instance()
#endif

 ...
 * This NPC-linking system in BlizzLike consists of 2 files:
 ...
 * This file contains the the headers needed for BlizzLike to link NPCs together
 *
 */
...
#define sCreatureLinkingMgr BlizzLike::Singleton<CreatureLinkingMgr>::Instance()

 ...
 * The Transport System in BlizzLike consists of these files:
 ...
 * This file contains the headers for base clases needed for BlizzLike to handle passengers on transports
 *
 */

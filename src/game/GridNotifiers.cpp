...
void BlizzLike::RespawnDo::operator()(Creature* u) const
{
...
void BlizzLike::RespawnDo::operator()(GameObject* u) const
{
...
void BlizzLike::CallOfHelpCreatureInRangeDo::operator()(Creature* u)
{
    if (u == i_funit)
        return;
...
bool BlizzLike::AnyAssistCreatureInRangeCheck::operator()(Creature* u)
{
    if (u == i_funit)
        return false;

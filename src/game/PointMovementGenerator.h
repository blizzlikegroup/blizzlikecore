...
template<class T>
class BLIZZLIKE_DLL_SPEC PointMovementGenerator
...
class BLIZZLIKE_DLL_SPEC AssistanceMovementGenerator
...
class BLIZZLIKE_DLL_SPEC FlyOrLandMovementGenerator : public PointMovementGenerator<Creature>
{
    public:

 ...
 * The mailing system in BlizzLike consists of mostly 4 files:
 * - Mail.h
 * - Mail.cpp
 * - MassMailMgr.h
 * - MassMailMgr.cpp
 ...
 *
 * @file MassMailMgr.h
 * This file contains the the headers needed for BlizzLike to handle mass mails send in safe and perfomence not affecting way.
 *
 */

#ifndef BLIZZLIKE_MASS_MAIL_MGR_H
#define BLIZZLIKE_MASS_MAIL_MGR_H
...
#define sMassMailMgr BlizzLike::Singleton<MassMailMgr>::Instance()

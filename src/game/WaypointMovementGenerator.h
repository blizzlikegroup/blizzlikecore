...
class BLIZZLIKE_DLL_SPEC PathMovementBase
{
    public:
...
template<class T>
class BLIZZLIKE_DLL_SPEC WaypointMovementGenerator;

template<>
class BLIZZLIKE_DLL_SPEC WaypointMovementGenerator<Creature>
 ...
 */
class BLIZZLIKE_DLL_SPEC FlightPathMovementGenerator

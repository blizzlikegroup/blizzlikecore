...
namespace BlizzLike
{
    ...
    class BLIZZLIKE_DLL_DECL GeneralLock
    {
        public:
    ...
    template<class T>
    class BLIZZLIKE_DLL_DECL SingleThreaded
    {
        public:
    ...
    class BLIZZLIKE_DLL_DECL ObjectLevelLockable
    {
        public:
    ...
    template<class T, class MUTEX>
    class BLIZZLIKE_DLL_DECL ClassLevelLockable
    {
        public:
...
#define INSTANTIATE_CLASS_MUTEX(CTYPE, MUTEX) \
    template class BLIZZLIKE_DLL_DECL BlizzLike::ClassLevelLockable<CTYPE, MUTEX>

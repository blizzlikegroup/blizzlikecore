...
class WorldTimer
{
    public:
        ...
        static BLIZZLIKE_DLL_SPEC uint32 tickTime();
        // get previous world tick time
        static BLIZZLIKE_DLL_SPEC uint32 tickPrevTime();
        // tick world timer
        static BLIZZLIKE_DLL_SPEC uint32 tick();
    ...
    private:
        ...
        static BLIZZLIKE_DLL_SPEC uint32 m_iTime;
        static BLIZZLIKE_DLL_SPEC uint32 m_iPrevTime;
};

...
class BLIZZLIKE_DLL_SPEC PostgreSQLConnection : public SqlConnection
{
    public:
...
class BLIZZLIKE_DLL_SPEC DatabasePostgre : public Database
{
        friend class BlizzLike::OperatorNew<DatabasePostgre>;

...
class BLIZZLIKE_DLL_SPEC MySqlPreparedStatement : public SqlPreparedStatement
{
    public:
...
class BLIZZLIKE_DLL_SPEC MySQLConnection : public SqlConnection
{
    public:
...
class BLIZZLIKE_DLL_SPEC DatabaseMysql : public Database
{
        friend class BlizzLike::OperatorNew<DatabaseMysql>;

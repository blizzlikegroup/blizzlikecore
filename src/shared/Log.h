...
#ifndef BLIZZLIKESERVER_LOG_H
#define BLIZZLIKESERVER_LOG_H
...
void BLIZZLIKE_DLL_SPEC outstring_log(const char* str, ...) ATTR_PRINTF(1, 2);
void BLIZZLIKE_DLL_SPEC detail_log(const char* str, ...) ATTR_PRINTF(1, 2);
void BLIZZLIKE_DLL_SPEC debug_log(const char* str, ...) ATTR_PRINTF(1, 2);
void BLIZZLIKE_DLL_SPEC error_log(const char* str, ...) ATTR_PRINTF(1, 2);
void BLIZZLIKE_DLL_SPEC error_db_log(const char* str, ...) ATTR_PRINTF(1, 2);
void BLIZZLIKE_DLL_SPEC setScriptLibraryErrorFile(char const* fname, char const* libName);
void BLIZZLIKE_DLL_SPEC script_error_log(const char* str, ...) ATTR_PRINTF(1, 2);
